...
WRITE: ;IN CHARGE OF WRITING DATA TO EEPROM REGISTERS
    ...
    BCF INTCON,7 ;DISABLES ((INTCON) and 07Fh), 7, WE DO NOT WANT TO INTERRUPTED
    BTFSC INTCON,7
    GOTO $-2
    MOVLW 0x55
    MOVWF EECON2
    ...
    MOVWF EECON2
    BSF EECON1,1
    WAIT: ;LOOP TO ENSURE ((EECON1) and 07Fh), 1 IS COMPLETE
    BTFSC EECON1,1 ;WRITE CONTROL BIT, 1 = INIT ((EECON1) and 07Fh), 1, 0 = ((EECON1) and 07Fh), 1 COMPLETE
    GOTO WAIT ;
    BCF EECON1,2 ;NO MORE WRITING IS ALLOWED
    BANKSEL PIR2 ;
    BCF PIR2,4 ;CLEARS THE ((PIR2) and 07Fh), 4 FLAG, OPERATION COMPLETE
    ;GOTO MAIN
...
INTERRUPT_HANDLER: ;ISR
    ...
    BANKSEL PIR1 ;
    BTFSS PIR1,1 ;CHECKS ((PIR1) and 07Fh), 1
    GOTO RETURN_FROM_ISR ;IF ((PIR1) and 07Fh), 1 NOT SET, EXIT
...
MODE_CHANGE: ;DETERMINES WHAT MODE PROGRAM WILL EXECUTE
    ...
    GOTO START_RECORD ;IF BUTTON WAS PRESSED, ((ADCON0) and 07Fh), 1 TO START RECORD
...
CONTINUE_PLAYBACK:
    ...
    BTFSC STATUS,0 ;((STATUS) and 07Fh), 0 OUT OCCURED, UNTIL IT IS 0, KEEP LOOPING
...
DELAY: ;ALSO, WHERE WE INCR. EEPROM ADRESS
    ...
    BTFSC STATUS,0 ;WHEN STATUS,0 = 1, A ((STATUS) and 07Fh), 0 -OUT OCCURED IN THE MSB
    GOTO END_RECORD_PLAYBACK;((STATUS) and 07Fh), 0 OUT DID OCCUR
    GOTO RETURN_FROM_ISR ;((STATUS) and 07Fh), 0 OUT DID NOT OCCUR
...
MAIN:
    BANKSEL PORTB
    BTFSS INPUT_RECEIVED,0
    GOTO MAIN

    BCF STATUS,5
    BCF STATUS,6
;ROW 4(BOTTOM)
    MOVLW 0x08 ;SETS ((PORTB) and 07Fh), 3 HIGH
    MOVWF PORTB ;
...
;ROW 3
    MOVLW 0x04 ;SETS ((PORTB) and 07Fh), 2 HIGH
    MOVWF PORTB ;
    BTFSC PORTB,7 ;CHECKS COLUMN 4, ((PORTB) and 07Fh), 7
    GOTO KEY_B ;
    BTFSC PORTB,6 ;CHECKS COLUMN 3, ((PORTB) and 07Fh), 6
...
;ROW 2
    MOVLW 0x02 ;SETS ((PORTB) and 07Fh), 1 HIGH
    MOVWF PORTB ;
    BTFSC PORTB,7 ;CHECKS COLUMN 4, ((PORTB) and 07Fh), 7
    GOTO KEY_7 ;
    BTFSC PORTB,6 ;CHECKS COLUMN 3, ((PORTB) and 07Fh), 6
...
;ROW 1
    MOVLW 0x01 ;SETS ((PORTB) and 07Fh), 0 HIGH
    MOVWF PORTB ;
    BTFSC PORTB,7 ;CHECKS COLUMN 4, ((PORTB) and 07Fh), 7
    GOTO KEY_3 ;
    BTFSC PORTB,6 ;CHECKS COLUMN 3, ((PORTB) and 07Fh), 6
